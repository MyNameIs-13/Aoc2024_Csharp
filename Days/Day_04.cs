namespace AdventOfCode
{
    ...
    public class Day_04 : BaseDay
    {
        ...
        private int findWordOccurences(GridUtils<char> grid, ReadOnlySpan<char> word)
        {
            ...
            {
                for (int sx = 0; sx < puzzleGrid.ColumnCount; sx++)
                {
        ...
        private int findWordOccurencesInXForm(GridUtils<char> grid, ReadOnlySpan<char> word)
        {
            ...
            var upLeftDir = GridDirectionUtils.DiagonalDirections[Direction.UpLeft];
            var downRightDir = GridDirectionUtils.DiagonalDirections[Direction.DownRight];
    
            // Diagonal 2: up-right <-> down-left
            var downLeftDir = GridDirectionUtils.DiagonalDirections[Direction.DownLeft];
            var upRightDir = GridDirectionUtils.DiagonalDirections[Direction.UpRight];
